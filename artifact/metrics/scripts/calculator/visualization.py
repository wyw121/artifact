    ...
    def generate(self, applications, relationships):
        for application in applications:
            ...
            try:
                ...
                print(f"Warning: table_accesses.csv not found for {application}. Skipping data access visualization.")
                table_accesses = {}
                        ...
                        for granularity in granularities:
                            ...
                            for relationship in relationships:
                                ...
                                try:
                                    ...
                                    print(f"Warning: trace.log not found for {application}. Skipping use case visualization.")
                                    use_case_accesses = {}
